...
contract DeedRepository is ERC721 {
    ...
    modifier onlyOwnerOf(uint256 _tokenId) {
        require(super.ownerOf(_tokenId) == msg.sender, "owner required");
        _;
    }

    /**
     * @dev Public function to register a new deed
     * @dev Call the ERC721 minter
    ...
    /**
     * @dev Public function to check if deed exists
     * @param _tokenId represents a specific deed
     * @return whether the deed exists or not
     */
